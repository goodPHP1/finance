                ...
                <li class="item" id="user_menu_my" name="user_menu_my">
                    ...
                    <ul class="sub">
                        <li><a href="/my/index">个人主页</a></li><li><a class="current" href="/my/info">个人资料</a></li><li>
                            <a href="/my/approve">认证管理</a></li><li><a href="密码管理.htm">密码设置</a></li><li><a href="/my/recommend">
                                推荐有奖</a></li></ul>
                </li>
        ...
        <div class="u-main">
            ...
            <div id="tab_box">
                <div class="u-form-wrap">
                    <div class="uf-tips">
                        <span class="red">  
<form action="/my/update" method="get"> 
         <table class="form_table" width="100%" cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($data as $k => $val): ?>
                 <tr>          
                 <th>头像:</th></td>              
                 <td><img src="images/1.gif" class="avatar" height="90" /></td>
               </tr>
             <tr>
                    <th>姓名：</th>
                    <td>{{$val->name}}</td>
            ...
            <form action="/my/upd" method="get">
               ...
               <ul class="info-img">
                    <li>
                    头像：<img src="images/1.gif" class="avatar" height="90" />
                 </li>
               </ul>
                <tr>
                    <th>姓名：</th>
