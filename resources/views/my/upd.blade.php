        ...
        <div class="u-menu">
            <ul class="u-nav" id="user_menu">
                <li class="item" id="user_menu_my" name="user_menu_my">
                    ...
                    <ul class="sub">
                        <li><a href="/my/index">个人主页</a></li><li><a class="current" href="/my/info">个人资料</a></li><li>
                            <a href="认证管理.htm">认证管理</a></li><li><a href="密码管理.htm">密码设置</a></li><li><a href="/my/recommend">
                                推荐有奖</a></li></ul>
                </li>
        ...
        <div class="u-main">
            <div id="tab_menu">
                <ul class="u-tab clearfix">
                    <li class="current"><a>工作认证信息</a></li>
                </ul>
            </div>
            <div id="tab_box">
         ...
         <form action="/my/upp" method="get">           
          <table>   
                ...
                <tr>
                    <th>性别：</th>
                    <td>
                        <input type="text" name="sex" value="<?php echo $data[0]->sex;?>">
                    </td>
                </tr>
                <tr>
                    <th>出生日期：</th>
                    <td>
                        <input type="text" name="day" value="<?php echo $data[0]->day;?>">   
                    </td>
                </tr>
                 <tr>
                    <th>年龄：</th>
                ...
                <tr>
                    <td>说明</td>
                    <td><input type="text" name="content" value="<?php echo $data[0]->content;?>"></td>
                </tr>
            <th></th>
                <td><label class="btn"><input type="submit" value="保存基本信息" /></label></td></tr>
            </table>                                   
                ...
                <tr>
                    <th>性别：</th>
                    <td>
                        <input type="text" name="name" value="<?php echo $data[0]->sex;?>">
                    </td>
                </tr>
                <tr>
                    <th>出生日期：</th>
                    <td>
                        <input type="text" name="name" value="<?php echo $data[0]->day;?>">
                 ...
                 <tr>
                    ...
                    <td><input type="text" name="name" value="<?php echo $data[0]->age;?>"></td>
                </tr>
                <tr>
                    <th>邮箱地址：</th>
                    <td><input type="text" name="name" value="<?php echo $data[0]->email;?>"></td>
                 
                </tr>
                <tr>
                    <th>手机号码：</th>
                    <td><input type="text" name="name" value="<?php echo $data[0]->tel;?>"</td>
                </tr>
                <tr>
            <th></th>
                <td><label class="btn"><input type="submit" value="保存基本信息" /></label></td></tr>
