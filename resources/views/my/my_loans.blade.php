        ...
        <div class="u-menu">
            <ul class="u-nav" id="user_menu">
                ...
                <li class="item" id="user_menu_funds" name="user_menu_funds">
                    ...
                    <ul class="sub">
                        <li><a href="资金记录.htm">资金记录</a></li><li><a href="/my/top_up">充值记录</a></li><li><a href="提现中心.htm">
                ...
                <li class="item" id="user_menu_loan" name="user_menu_loan">
                    ...
                    <ul class="sub">
                        <li><a class="current" href="javascript:;">我的贷款</a></li><li><a href="/my/repay">偿还贷款</a></li><li><a href="/mystatistical">贷款统计</a></li>                        
                        </ul>
                </li>
            </ul>
