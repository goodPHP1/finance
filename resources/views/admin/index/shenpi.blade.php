...
<meta http-equiv="Cache-Control" content="no-siteapp" />
        <base href="{{ URL::asset('/admin/js/') }}">
	    <base href="{{ URL::asset('/admin/css/') }}">
	    <base href="{{ URL::asset('/admin/images/') }}">
	    <base href="{{ URL::asset('/admin/assets/') }}">
	   <!--  <base href="{{ URL::asset('/admin/font/') }}"> -->
	    <!-- <base href="{{ URL::asset('/admin/products/') }}">
	    <base href="{{ URL::asset('/admin/upload/') }}">
	    <base href="{{ URL::asset('/admin/Widget/') }}"> -->
 ...
 <div class="sort_style">
  ...
  <div class="sort_list">
    <table class="table table-striped table-bordered table-hover" id="sample-table">
		<thead>
		 <tr>
				...
				<th width="50px">ID</th>
				<th width="100px">贷款人</th>
				<th width="100px">贷款金额</th>
				<th width="200px">贷款用途</th>
				<th width="180px">贷款时间</th>
				<th width="70px">状态</th>                
	...
	<?php foreach ($data as $key => $val): ?>
       ...
       <?php endif ?>
       <?php if ($val->status==0): ?>
       		<td class="td-status"><span class="label label-success radius">未通过</span></td>
       <?php endif ?>
       
      	<td class="td-manage">
        <a onClick="member_stop(this,'<?=$val->id;?>')"  href="javascript:;" title="通过"  class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a>   
        ...
        <a href="javascript:ovid()" name="Ads_list.html" class="btn btn-xs btn-pink ads_link" onclick="AdlistOrders('561');" title="详情"><i class="fa  fa-bars  bigger-120"></i></a>
       </td>
      </tr>
	<?php endforeach ?>
